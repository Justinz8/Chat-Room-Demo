...
export default function AddChat() {
    function AddChatPopUpBody() {
        ...
        function AddChatNameFormHandler(
        ...
        return (
            <div className="AddChat-Body">
                ...
                <form
                    onSubmit={handleAddChatFormSubmit}
                    className="AddChat-Form"
                >
                    ...
                    <input
                        type="text"
                        id="AddChat-ChatName"
                        onChange={AddChatNameFormHandler}
                        value={AddChatForm.Name}
                    ></input>
                    <h3>Select friends to add to chat: </h3>
                    <select
                        id="AddChat-AddFriend"
                        value={""}
                        onChange={(e) => {
                            AddChatFormAddFriendHandler(e.target.value);
                        }}
                    >
                        <option></option>
                        {FriendOptions}
    ...
    return (
        <div>
            <Popup
                trigger={<button className="Sidebar-Button">Make Chat</button>}
            >
                <AddChatPopUpBody />
            </Popup>
        </div>
