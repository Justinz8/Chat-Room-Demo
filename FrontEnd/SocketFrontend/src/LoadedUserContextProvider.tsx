...
interface LoadedUserContextType {
    ...
    SetLoadedUsers: React.Dispatch<
        React.SetStateAction<Map<string, KnownUser>>
    >;
}
...
export function LoadedUserProvider(props: props) {
    ...
    */
    ...
    const [LoadedUsers, SetLoadedUsers] = useState<Map<string, KnownUser>>(
        new Map<string, KnownUser>()
    );
    ...
    return (
        <LoadedUserContext.Provider value={LoadedUserValue}>
            {props.children}
